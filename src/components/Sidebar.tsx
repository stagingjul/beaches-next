  ...
  return (
    <a
      ...
      className={cx(
        ...
        "data-[active=true]:text-secondary data-[active=true]:font-semibold data-[active=true]:dark:text-blue-500 data-[active=true]:bg-white data-[active=true]:shadow-md",
        focusRing,
      )}
      {...props}
    >
